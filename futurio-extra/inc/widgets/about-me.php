...
if ( !class_exists( 'Futurio_Extra_About_Me_Widget' ) ) {
	...
	class Futurio_Extra_About_Me_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			// Start up widget
			parent::__construct(
			'futurio_about_me', esc_html__( 'Futurio: About Me', 'futurio-extra' ), array(
		...
		public function form( $instance ) {
			...
			<p>
				...
				<textarea rows="15" id="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'text' ) ); ?>" class="widefat" style="height: 100px;"><?php
